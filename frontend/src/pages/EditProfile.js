...
function EditProfile() {
  ...
  const fetchProfile = async () => {
    try {
   const res = await axios.get(`https://safelink-backend-ccyn.onrender.com/api/profile`,{
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
    await axios.put(`https://safelink-backend-ccyn.onrender.com/api/profile`, form, {
        headers: { authorization: token }
      });
